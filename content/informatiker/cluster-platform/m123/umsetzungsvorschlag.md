---
aliases:
  - /cluster-platform/m123/umsetzungsvorschlag/
  - /v2/cluster-platform/m123/umsetzungsvorschlag/
...
| 5                | Einführung  in **Dienst DHCP** <br />- Einrichten Umgebung <br />- Auftrag DHCP (Windows und/oder Linux) | B2, C, D, E, F, G, J    | Betriebssysteme, virtuelle Maschinen                         |
...
| 2                | Betriebsdokumentation und Abnahmeprotokoll für Serverdienst aufzeigen und Auftrag eine solche zu erstellen (zu beliebigem Dienst) | K                       | Office-Programme, Visio, [Diagrams](https://app.diagrams.net/) |
| 4                | Einführung in **Dienst DNS**, Einrichten und Auftrag (Windows und/oder Linux) mit Testprotokoll | B3, C, D, E, E, F, G, J | Betriebssysteme                                              |
| 4                | Logfiles analysieren, Sicheheitsbetrachtungen und -anpassungen an vorhandenen Diensten vornehmen | C, G, I, J              | Systemtools für Netzwerkanalyse                              |
