---
aliases:
  - /cluster-platform/m141/umsetzungsvorschlag/
  - /v2/cluster-platform/m141/umsetzungsvorschlag/
title: Umsetzungsvorschlag
weight: 10
draft: false
---

# Umsetzungsvorschlag - Modul 141
...
| 8 | Inbetriebnahme eines nicht-relationalen DBMS, Datenimport, Berechtigungen, Abnahme (z. B. verschiedene Fallstudien in Gruppen) | A-E | nicht-relationales DBMS (Key-Value [MongoDB](https://www.mongodb.com/) / Time-Series [Prometheus](https://prometheus.io/) / [Influx DB](https://www.influxdata.com/)) |
